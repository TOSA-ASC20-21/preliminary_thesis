	...
	\section{Team introduction}
		...
		\captionsetup[figure]{labelfont={bf},name={Photo.},labelsep=period}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.3\textwidth]{Lu.jpg}
				\caption{Liu Kongyang} %图片标题
				\label{photo:2}  %图片交叉引用时的标签
			\end{figure} 
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.3\textwidth]{Lu.jpg}
				\caption{Qiu Zili} %图片标题
				\label{photo:3}  %图片交叉引用时的标签
			\end{figure} 
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.3\textwidth]{Lu.jpg}
				\caption{Jiang Wenyuan} %图片标题
				\label{photo:4}  %图片交叉引用时的标签
			\end{figure} 
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.3\textwidth]{Lu.jpg}
				\caption{Xia Wenyong} %图片标题
				\label{photo:5}  %图片交叉引用时的标签
			\end{figure} 
